...
Thus, $\displaystyle\iiint\limits_{\Delta v} f d \tau>0$ (contradiction).
...
Recall definition of Del operator $\left(\frac{\partial F_{1}}{\partial x}+\frac{\partial F_{2}}{\partial y}+\frac{\partial F_{3}}{\partial z}\right)$.\\
...
\begin{equation*}
\therefore \dfrac{d H}{d t}=\iiint\limits_{\tau} \dfrac{\partial}{\partial t}[c \delta \psi] d \tau = (3)
\end{equation*}
